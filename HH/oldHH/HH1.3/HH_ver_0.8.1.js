...
function draw() {
	...
	window["Vt"+i] = JSON.parse(JSON.stringify(Vt));	
}
}
  	var oldVt = {
  		x: t,
  	...
  	if (userlast10Flag.checked) {
		...
		if(!userDendrite.checked){
  		Plotly.newPlot('myDiv1', [Vt, curinjm, curinjm2], layout, config); 
			...
			Plotly.newPlot('myDiv1', [Vt, Vt1, Vt2, Vt3, Vt4, Vt5, Vt6, Vt7, Vt8, Vt9, Vt0], layout, config)
		}
